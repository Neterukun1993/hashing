import pytest
from src.hash_function.tabulation_hash import TabulationHash
from src.hash_set.cuckoo_hash_set import CuckooHashSet


@pytest.fixture
def hash_set():
    return CuckooHashSet(TabulationHash(), TabulationHash())
